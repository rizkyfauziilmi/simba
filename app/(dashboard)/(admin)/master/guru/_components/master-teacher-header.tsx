...
export const MasterTeacherHeader = () => {
  ...
  return (
    <div className="flex md:items-center md:justify-between flex-col md:flex-row md:gap-0 gap-4">
      <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Daftar Guru</h3>
      <div className="flex items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="secondary" disabled={teachers.length === 0}>
              <DownloadIcon />
              Unduh Data
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onSelect={() => downloadCSV(teachers, 'data-guru')}>
              CSV
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={() => downloadExcel(teachers, 'data-guru')}>
              Excel
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={() => downloadPDF(teachers, 'data-guru')}>
              PDF
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
