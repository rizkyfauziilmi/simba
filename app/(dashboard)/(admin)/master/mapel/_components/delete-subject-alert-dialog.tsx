...
export function DeleteSubjectAlertDialog({
  ...
  const deleteSubjectMutationOptions =
    trpc.subject.deleteSubject.mutationOptions({
      onSuccess: (data) => {
    ...
    <AlertDialog open={open} onOpenChange={(open) => setOpen(open)}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Menghapus mata pelajaran ini akan menghapus semua data terkait mata
            pelajaran ini, termasuk jadwal, guru pengampu, dan lainnya.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
