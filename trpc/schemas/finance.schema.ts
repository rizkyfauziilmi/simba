...
export const createTransactionSchema = z.object({
  ...
  category: z.string('Kategori tidak boleh kosong.').min(1, { message: 'Kategori harus diisi.' }),
  amount: z.number('Jumlah tidak valid.').min(1, { message: 'Jumlah harus minimal Rp 1.' }),
