...
export function BanUserAlertDialog({
  ...
  const banUser = async () => {
    const banDuration = BAN_DURATIONS.find(d => d.label === banDurationSelect)
      ...
      description: (
        <ul>
          ...
          <li>
            ...
            {banDuration?.value ? secondsToReadable(banDuration.value) : 'Permanen'}
          </li>
        </ul>
      ),
    })
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Apakah Anda yakin ingin memblokir pengguna ini?</AlertDialogTitle>
          <AlertDialogDescription>
            Tindakan ini akan mencegah pengguna mengakses akun dan semua layanan terkait. Tindakan
