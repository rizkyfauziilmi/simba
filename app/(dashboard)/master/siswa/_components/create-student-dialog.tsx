...
import { CalendarIcon, LoaderIcon, UserPlus } from "lucide-react";
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            siswa akan mendapatkan akun dengan email dan password yang
            dihasilkan secara otomatis. (pass: nama@1234)
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
