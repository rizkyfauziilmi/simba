...
export function JadwalPelajaran() {
  ...
  const { data } = useSuspenseQuery(
    trpc.class.getMySchoolTimeable.queryOptions(),
  );

  // Sort data by day
  const sortedData = [...data].sort(
    (a, b) => hariOrder[a.hari] - hariOrder[b.hari],
  );
  ...
  const todaySchedules = todayHariEnum
    ? groupedByDay[todayHariEnum]
    : todayHariEnum;
