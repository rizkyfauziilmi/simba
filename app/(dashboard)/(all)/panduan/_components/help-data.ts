...
export const adminHelpData: HelpData = {
  ...
  description: 'Panduan lengkap untuk pengelolaan Sistem Informasi Manajemen Bustanul Arifin',
  ...
  features: [
    {
      ...
      description: 'Kelola informasi siswa, guru, kelas, dan mata pelajaran termasuk jadwal',
      tips: [
    ...
    },
    {
      ...
      description: 'Catat pengeluaran dan pemasukan dengan filter tanggal dan kategori',
      tips: [
    ...
    {
      name: 'Ekspor Data',
      description: 'Unduh data master atau laporan keuangan dalam format CSV, Excel, atau PDF',
      tips: [
    ...
    },
    {
      ...
      description: 'Kelola informasi profil, keamanan akun, dan sesi login Anda',
      tips: [
    ...
    },
    {
      ...
      description: 'Pilih tema tampilan yang sesuai dengan preferensi visual Anda',
      tips: [
  ...
  features: [
    {
      ...
      description: 'Lihat jadwal mengajar yang telah disusun oleh administrator sekolah',
      tips: [
  ...
  features: [
    {
      ...
      description: 'Lihat jadwal pelajaran kelas Anda yang telah disusun oleh sekolah',
      tips: [
        'Periksa jadwal secara rutin untuk mempersiapkan pembelajaran',
