...
export function EditTeacherForm() {
  ...
  const updateTeacherMutationOptions = trpc.teacher.updateTeacher.mutationOptions({
    onError: error => {
  ...
  const isLoading = updateTeacherMutation.isPending || form.formState.isSubmitting
